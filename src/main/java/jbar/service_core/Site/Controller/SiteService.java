...
public class SiteService {
    ...
    public ResponseEntity<Message> findById(Integer id) {
        ...
        if (site.isPresent()) {
            ...
            return new ResponseEntity<>(new Message(site.get(), "Site found", TypesResponse.SUCCESS), HttpStatus.OK);
        } else {
    ...
    public ResponseEntity<Message> create(SiteDTO siteDTO) {
        ...
        return new ResponseEntity<>(new Message(site, "Site created", TypesResponse.SUCCESS), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<Message> update(Integer id, SiteDTO siteDTO) {
        ...
        if (existingSite.isPresent()) {
            ...
            return new ResponseEntity<>(new Message(site, "Site updated", TypesResponse.SUCCESS), HttpStatus.OK);
        } else {
